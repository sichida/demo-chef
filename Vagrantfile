...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "shoun-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/ichida"
  #   chef.validation_client_name = "ichida-validator"
  #   chef.validation_key_path = ".chef/ichida-validator.pem"
  # end
end
